# Steps to Start Practice Course with HireReady

## ✅ PART 1 — Create ONE GitHub Repository
# 1. Go to [github.com](https://github.com)
# 2. Login
# 3. Click `+` (top right) → New repository
# 4. Repository name: `Batch_Name_HireReady` (e.g., `Dec2025_Neeraj_HireReady`)
# 5. Select **Public**
...
mkdir Batch_Name_HireReady
cd Batch_Name_HireReady
...
git remote add origin https://github.com/your-username/Batch_Name_HireReady.git
